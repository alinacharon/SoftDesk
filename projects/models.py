...
class Contributor(models.Model):
    ...
    issue = models.ForeignKey('Issue', on_delete=models.CASCADE, null=True, blank=True, related_name='issue_contributors')
...
class Project(models.Model):
    ...
    contributors = models.ManyToManyField(User, related_name='projects', through=Contributor) 
